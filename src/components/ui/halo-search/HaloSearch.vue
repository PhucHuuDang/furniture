<template>
  <div id="halo-search" :class="props.class">
    ...
    <div id="search-wrapper">
      ...
      <span
        :class="[
          'absolute top-2 right-2 isolate z-[2] flex size-full max-h-10 max-w-10 items-center justify-center overflow-hidden rounded-lg border border-solid border-transparent',
        ]"
