<template>
  <div
    ...
    :class="
      cn(
        'relative flex size-full items-center justify-center overflow-hidden rounded-md transition-colors focus:ring-1 focus:outline-none',
        props.class,
      )
    "
    :style="{
...
const props = defineProps({
  ...
  enterActiveClass: {
    type: String,
    default: "transition-transform duration-200 ease-in-out",
  },
  leaveActiveClass: {
    type: String,
    default: "transition-transform duration-200 ease-in-out",
