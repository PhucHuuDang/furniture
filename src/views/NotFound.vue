      ...
      <div className="flex justify-center">
        <div className="w-full sm:w-10/12 md:w-8/12 text-center">
          ...
          <div className="mt-[-50px]">
            <h3 className="text-2xl text-olive sm:text-3xl font-bold mb-4">
            ...
            <Button
              variant="default"
              className="my-5 bg-green-600 hover:bg-green-700 rounded-2xl p-4 cursor-pointer transition duration-300 hover:scale-105 ease-in-out"
            >
              <div @click="router.push('/')">Go to Home</div>
            </Button>
          </div>
        </div>
      </div>
